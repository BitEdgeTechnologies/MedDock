...
import { UltrasoundAnalyzerForm } from "./ultrasound-analyzer-form";
import Link from "next/link";
import { ChevronLeft } from "lucide-react";

export default function UltrasoundAnalyzerPage() {
  return (
        ...
        <div className="mx-auto w-full max-w-4xl">
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-muted-foreground">
              Upload an ultrasound image and provide clinical context for an AI-powered interpretation.
            </p>
             <p className="mt-1 text-xs text-destructive">
              Disclaimer: For educational purposes only. Not a substitute for professional radiological review.
            </p>
          </div>
          <UltrasoundAnalyzerForm />
        </div>
      </main>
    </div>
  );
