...
import { UrineAnalyzerForm } from "./urine-analyzer-form";
import Link from "next/link";
import { ChevronLeft } from "lucide-react";

export default function UrineAnalyzerPage() {
  return (
        ...
        <div className="mx-auto w-full max-w-2xl">
          ...
          <div className="text-center">
            <h1 className="font-headline text-3xl font-bold tracking-tighter sm:text-4xl text-shadow-neon-primary">
              Urine Report Analyzer
            </h1>
            <p className="mt-2 text-muted-foreground">
              Paste a urinalysis report to get an AI-powered interpretation.
            </p>
