        ...
        <div className="mx-auto w-full max-w-2xl">
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-muted-foreground">
              Generate a structured case summary from unstructured clinical notes.
            </p>
             <p className="mt-1 text-xs text-destructive">
              Disclaimer: For educational use. Verify all AI-generated content against source documents.
            </p>
          </div>
          <CaseSummaryForm />
        </div>
